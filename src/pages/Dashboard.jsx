...
function Dashboard() {
    ...
    const fetchTotalSaleAmount = () => {
        fetch(`${apiUrl}/api/sales/get/${authContext.user}/totalsaleamount`)
    ...
    const fetchTotalPurchaseAmount = () => {
        fetch(
            `${apiUrl}/api/purchase/get/${authContext.user}/totalpurchaseamount`,
        )
            .then((response) => response.json())
    ...
    const fetchMonthlySalesData = () => {
        fetch(`${apiUrl}/api/sales/getmonthly`)
            .then((response) => response.json())
